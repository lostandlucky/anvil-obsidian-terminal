...
- Audit notes committed as `specs/terminal-plugin/phase-0-audit.md` covering: what the package downloads and from where, how it verifies the Obsidian binary, what it writes outside the project dir, what lifecycle hooks it runs. Must end with an explicit "safe to adopt / not safe / conditional" conclusion.
...
7. `specs/terminal-plugin/phase-0-audit.md` exists, covers the four audit questions, and ends with an explicit verdict
...
- **Meta-plan:** `specs/terminal-plugin/meta-plan.md` (Phase 0 section)
- **Testing approach:** `specs/terminal-plugin/testing-approach.md`
