...
The full mental model — three actors, the phasing rationale for why bubble at container is the unique sweet spot, the worked FI-007 incident, and the cross-platform implications for [FI-011](../../specs/anvil/future-ideas-backlog.md) — is documented in [`docs/explanations/keyboard-handling.md`](../explanations/keyboard-handling.md). This ADR records the decision; the Explanation carries the model.
